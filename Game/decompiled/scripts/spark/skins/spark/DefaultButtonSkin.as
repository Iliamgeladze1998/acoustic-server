package spark.skins.spark
{
   ...
   public class DefaultButtonSkin extends SparkButtonSkin implements IStateClient2
   {
      ...
      override protected function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number) : void
      {
         ...
         colorTransform.redOffset = ((accentColor & 255 << 16) >> 16) * 0.24;
         colorTransform.greenOffset = ((accentColor & 255 << 8) >> 8) * 0.24;
         colorTransform.blueOffset = (accentColor & 0xFF) * 0.24;
         colorTransform.alphaMultiplier = 1;
         this.fill.transform.colorTransform = colorTransform;
         if(Boolean(this.highlightStroke))
         {
            this.highlightStroke.transform.colorTransform = colorTransform;
         }
