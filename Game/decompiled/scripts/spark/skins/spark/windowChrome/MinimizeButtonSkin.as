package spark.skins.spark.windowChrome
{
   ...
   public class MinimizeButtonSkin extends Skin implements IStateClient2
   {
      ...
      private var _embed_mxml________________assets_win_min_down_png_1382249781:Class = MinimizeButtonSkin__embed_mxml________________assets_win_min_down_png_1382249781;
      
      private var _embed_mxml________________assets_win_min_over_png_1285073039:Class = MinimizeButtonSkin__embed_mxml________________assets_win_min_over_png_1285073039;
      
      private var _embed_mxml________________assets_win_min_dis_png_1538824187:Class = MinimizeButtonSkin__embed_mxml________________assets_win_min_dis_png_1538824187;
      
      private var _embed_mxml________________assets_win_min_up_png_869309893:Class = MinimizeButtonSkin__embed_mxml________________assets_win_min_up_png_869309893;
      ...
      private function _MinimizeButtonSkin_BitmapImage1_i() : BitmapImage
      {
         ...
         _loc1_.source = this._embed_mxml________________assets_win_min_up_png_869309893;
         _loc1_.left = 0;
      ...
      {
         var _loc1_:BitmapImage = new BitmapImage();
         _loc1_.source = this._embed_mxml________________assets_win_min_over_png_1285073039;
         _loc1_.left = 0;
         _loc1_.verticalCenter = 0;
         _loc1_.fillMode = "clip";
      ...
      {
         var _loc1_:BitmapImage = new BitmapImage();
         _loc1_.source = this._embed_mxml________________assets_win_min_down_png_1382249781;
         _loc1_.left = 0;
         _loc1_.verticalCenter = 0;
         _loc1_.fillMode = "clip";
      ...
      {
         var _loc1_:BitmapImage = new BitmapImage();
         _loc1_.source = this._embed_mxml________________assets_win_min_dis_png_1538824187;
         _loc1_.left = 0;
         _loc1_.verticalCenter = 0;
         _loc1_.fillMode = "clip";
