package spark.skins.spark.windowChrome
{
   ...
   public class MaximizeButtonSkin extends Skin implements IStateClient2
   {
      ...
      private var _embed_mxml________________assets_win_max_dis_png_357001249:Class = MaximizeButtonSkin__embed_mxml________________assets_win_max_dis_png_357001249;
      
      private var _embed_mxml________________assets_win_max_up_png_332399457:Class = MaximizeButtonSkin__embed_mxml________________assets_win_max_up_png_332399457;
      
      private var _embed_mxml________________assets_win_max_over_png_1925672181:Class = MaximizeButtonSkin__embed_mxml________________assets_win_max_over_png_1925672181;
      
      private var _embed_mxml________________assets_win_max_down_png_1122331505:Class = MaximizeButtonSkin__embed_mxml________________assets_win_max_down_png_1122331505;
      ...
      private function _MaximizeButtonSkin_BitmapImage1_i() : BitmapImage
      {
         ...
         _loc1_.source = this._embed_mxml________________assets_win_max_up_png_332399457;
         _loc1_.left = 0;
      ...
      {
         var _loc1_:BitmapImage = new BitmapImage();
         _loc1_.source = this._embed_mxml________________assets_win_max_over_png_1925672181;
         _loc1_.left = 0;
         _loc1_.verticalCenter = 0;
         _loc1_.fillMode = "clip";
      ...
      {
         var _loc1_:BitmapImage = new BitmapImage();
         _loc1_.source = this._embed_mxml________________assets_win_max_down_png_1122331505;
         _loc1_.left = 0;
         _loc1_.verticalCenter = 0;
         _loc1_.fillMode = "clip";
      ...
      {
         var _loc1_:BitmapImage = new BitmapImage();
         _loc1_.source = this._embed_mxml________________assets_win_max_dis_png_357001249;
         _loc1_.left = 0;
         _loc1_.verticalCenter = 0;
         _loc1_.fillMode = "clip";
