package soul.view.field.visual.players.models
{
   ...
   public class RatmanFemale extends UnitBitmap
   {
      
      public static const visualId:String = "ratman_f";
      
      public function RatmanFemale(hsl:String = "")
      {
         super();
         frameWidth = 87;
         frameHeight = 125;
         library = "ratman_f.swf";
         linkages = ["ratman1"];
         defaultFps = 12;
         frameList = {};
         ...
         nameHeight = 125;
         spriteCenter = new Point(-43,-104);
         hitArea = new Rectangle(20,26,47,91);
      }
   }
}
