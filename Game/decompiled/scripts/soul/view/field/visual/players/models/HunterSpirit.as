package soul.view.field.visual.players.models
{
   ...
   public class HunterSpirit extends UnitBitmap
   {
      
      public static const visualId:String = "hunter_spirit";
      
      public function HunterSpirit(hsl:String = "")
      {
         super();
         frameWidth = 95;
         frameHeight = 120;
         library = "hunter_spirit.swf";
         linkages = ["hunter1"];
