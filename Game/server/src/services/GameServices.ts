...
import { CharacterData, FieldUnit, GameCfg } from '../models/GameModels';
import { CommandSender } from './CommandSender';

export function registerGameServices(registry: ServiceRegistry, world: World, gameServer: GameServer): void {
  const clients: Map<string, GameClient> = new Map(); // characterId -> client
  ...
  registry.register('gameService', 'componentReady', (client, args) => {
    ...
    const sender = new CommandSender(client, gameServer);
    const charData = {
