package vega.util.zip
{
   ...
   public class ZipEntry
   {
      ...
      {
         var d:Date = new Date((this.dostime >> 25 & 0x7F) + 1980,(this.dostime >> 21 & 0x0F) - 1,this.dostime >> 16 & 0x1F,this.dostime >> 11 & 0x1F,this.dostime >> 5 & 0x3F,(this.dostime & 0x1F) << 1);
         return d.time;
      }
      ...
      public function set time(time:Number) : void
      {
         ...
         this.dostime = (d.fullYear - 1980 & 0x7F) << 25 | d.month + 1 << 21 | d.day << 16 | d.hours << 11 | d.minutes << 5 | d.seconds >> 1;
      }
