package
{
   ...
   [ExcludeClass]
   public class _soul_view_interaction_achievement_AchievementScreenWatcherSetupUtil implements IWatcherSetupUtil2
   {
      
      public function _soul_view_interaction_achievement_AchievementScreenWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         AchievementScreen.watcherSetupUtil = new _soul_view_interaction_achievement_AchievementScreenWatcherSetupUtil();
      }
