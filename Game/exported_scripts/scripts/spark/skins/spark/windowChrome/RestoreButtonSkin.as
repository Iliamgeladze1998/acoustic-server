package spark.skins.spark.windowChrome
{
   ...
   public class RestoreButtonSkin extends Skin implements IStateClient2
   {
      ...
      private var _embed_mxml________________assets_win_restore_up_png_1927759427:Class = RestoreButtonSkin__embed_mxml________________assets_win_restore_up_png_1927759427;
      
      private var _embed_mxml________________assets_win_restore_down_png_870356931:Class = RestoreButtonSkin__embed_mxml________________assets_win_restore_down_png_870356931;
      
      private var _embed_mxml________________assets_win_restore_over_png_686986815:Class = RestoreButtonSkin__embed_mxml________________assets_win_restore_over_png_686986815;
      ...
      private function _RestoreButtonSkin_BitmapImage1_i() : BitmapImage
      {
         ...
         _loc1_.source = this._embed_mxml________________assets_win_restore_up_png_1927759427;
         _loc1_.left = 0;
      ...
      {
         var _loc1_:BitmapImage = new BitmapImage();
         _loc1_.source = this._embed_mxml________________assets_win_restore_over_png_686986815;
         _loc1_.left = 0;
         _loc1_.verticalCenter = 0;
         _loc1_.fillMode = "clip";
      ...
      {
         var _loc1_:BitmapImage = new BitmapImage();
         _loc1_.source = this._embed_mxml________________assets_win_restore_down_png_870356931;
         _loc1_.left = 0;
         _loc1_.verticalCenter = 0;
         _loc1_.fillMode = "clip";
