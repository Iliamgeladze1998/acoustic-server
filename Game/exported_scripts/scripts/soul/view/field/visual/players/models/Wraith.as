package soul.view.field.visual.players.models
{
   ...
   public class Wraith extends UnitBitmap
   {
      
      public static const visualId:String = "wraith";
      
      public function Wraith(hsl:String = "")
      {
         super();
         frameWidth = 105;
         frameHeight = 140;
         ...
         frameList[AnimationType.BOW] = [0,[37]];
         frameList[AnimationType.END_BOW] = [0,[37,38,39,40,41]];
         frameList[AnimationType.WALK] = frameList[AnimationType.RUN] = [0,[42,43,44,45,46,47,48]];
         nameHeight = 130;
         spriteCenter = new Point(-52,-112);
         hitArea = new Rectangle(20,17,70,100);
      }
   }
}
