package soul.view.field.visual.players.models
{
   ...
   public class DrouFemale extends UnitBitmap
   {
      
      public static const visualId:String = "drou_f";
      
      public function DrouFemale()
      {
         super();
         frameWidth = 118;
         frameHeight = 127;
         ...
         nameHeight = 115;
         spriteCenter = new Point(-59,-100);
         hitArea = new Rectangle(35,9,50,103);
      }
   }
}
