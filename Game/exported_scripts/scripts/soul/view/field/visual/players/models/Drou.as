package soul.view.field.visual.players.models
{
   ...
   public class Drou extends UnitBitmap
   {
      
      public static const visualId:String = "drou";
      
      public function Drou(hsl:String = "")
      {
         super();
         frameWidth = 95;
         frameHeight = 145;
         ...
         frameList[AnimationType.END_BOW] = [0,[32,33,34]];
         ...
         nameHeight = 130;
         spriteCenter = new Point(-47,-116);
         hitArea = new Rectangle(21,17,54,106);
      }
   }
}
