package soul.view.interaction.inventory
{
   ...
   public class DropDialog extends Window implements IBindingClient
   {
      
      private static var _watcherSetupUtil:IWatcherSetupUtil2;
      
      public var _DropDialog_ItemRenderer1:ItemRenderer;
      ...
      public function DropDialog()
      {
         ...
         super();
         bindings = this._DropDialog_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_soul_view_interaction_inventory_DropDialogWatcherSetupUtil");
         ...
         {
            return DropDialog[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.children = [this._DropDialog_VBox1_c()];
         this.addEventListener("creationComplete",this.___DropDialog_Window1_creationComplete);
         i = 0;
      ...
      {
         DropDialog._watcherSetupUtil = param1;
      }
      ...
      private function set _3242771item(value:Item) : void
      {
         ...
         if(this.item.count > 0)
         {
            ...
            this.defaultCount = this.item.count;
         }
      }
      ...
      private function _DropDialog_VBox1_c() : VBox
      {
         var _loc1_:VBox = new VBox();
         _loc1_.width = 282;
         _loc1_.height = 125;
         _loc1_.children = [this._DropDialog_HBox1_c(),this._DropDialog_GradientBox1_c()];
         return _loc1_;
      }
      
      private function _DropDialog_HBox1_c() : HBox
      {
         var _loc1_:HBox = new HBox();
         _loc1_.gap = 10;
         _loc1_.padding = 10;
         _loc1_.verticalAlign = "bottom";
         _loc1_.children = [this._DropDialog_ItemRenderer1_i(),this._DropDialog_VBox2_c()];
         return _loc1_;
      }
      
      private function _DropDialog_ItemRenderer1_i() : ItemRenderer
      {
         var _loc1_:ItemRenderer = new ItemRenderer();
         this._DropDialog_ItemRenderer1 = _loc1_;
         BindingManager.executeBindings(this,"_DropDialog_ItemRenderer1",this._DropDialog_ItemRenderer1);
         return _loc1_;
      }
      
      private function _DropDialog_VBox2_c() : VBox
      {
         var _loc1_:VBox = new VBox();
         _loc1_.gap = 10;
         _loc1_.children = [this._DropDialog_HBox2_c(),this._DropDialog_HBox3_c()];
         return _loc1_;
      }
      
      private function _DropDialog_HBox2_c() : HBox
      {
         var _loc1_:HBox = new HBox();
         _loc1_.gap = 10;
         _loc1_.children = [this._DropDialog_Slider1_i(),this._DropDialog_Input1_i()];
         return _loc1_;
      }
      
      private function _DropDialog_Slider1_i() : Slider
      {
         var _loc1_:Slider = null;
         _loc1_ = new Slider();
         _loc1_.width = 126;
         _loc1_.height = 20;
         _loc1_.minValue = 1;
      ...
      private function _DropDialog_Input1_i() : Input
      {
      ...
      private function _DropDialog_HBox3_c() : HBox
      {
         var _loc1_:HBox = new HBox();
         _loc1_.gap = 15;
         _loc1_.children = [this._DropDialog_Button11_i(),this._DropDialog_Button12_i(),this._DropDialog_Button13_i()];
         return _loc1_;
      }
      
      private function _DropDialog_Button11_i() : Button1
      {
      ...
      private function _DropDialog_Button12_i() : Button1
      {
         var _loc1_:Button1 = new Button1();
         _loc1_.width = 50;
         _loc1_.height = 28;
      ...
      private function _DropDialog_Button13_i() : Button1
      {
         var _loc1_:Button1 = new Button1();
         _loc1_.width = 50;
         _loc1_.height = 28;
      ...
      private function _DropDialog_GradientBox1_c() : GradientBox
      {
      ...
      public function ___DropDialog_Window1_creationComplete(event:SimpleUIEvent) : void
      {
         this.creationComplete();
      }
      
      private function _DropDialog_bindingsSetup() : Array
      {
         var result:Array = [];
         result[0] = new Binding(this,function():String
         {
            var _loc1_:* = LocaleManager.getString(BundleName.INTERFACE,"drop.title");
            return _loc1_ == undefined ? null : String(_loc1_);
         },null,"this.label");
         result[1] = new Binding(this,null,null,"_DropDialog_ItemRenderer1.item","item");
