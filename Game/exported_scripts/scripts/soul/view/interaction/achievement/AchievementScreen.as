package soul.view.interaction.achievement
{
   ...
   public class AchievementScreen extends Container implements IBindingClient
   {
      
      private static var _watcherSetupUtil:IWatcherSetupUtil2;
      
      public var _AchievementScreen_CachedImage1:CachedImage;
      
      public var _AchievementScreen_CachedImage2:CachedImage;
      ...
      public function AchievementScreen()
      {
         ...
         super();
         bindings = this._AchievementScreen_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_soul_view_interaction_achievement_AchievementScreenWatcherSetupUtil");
         ...
         {
            return AchievementScreen[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.width = 784;
         this.height = 452;
         this.children = [this._AchievementScreen_PointsProgress1_i(),this._AchievementScreen_CachedImage1_i(),this._AchievementScreen_CachedImage2_i(),this._AchievementScreen_AchievementCategories1_i(),this._AchievementScreen_List1_i(),this._AchievementScreen_AchievementList1_i()];
         this.addEventListener("creationComplete",this.___AchievementScreen_Container1_creationComplete);
         i = 0;
      ...
      {
         AchievementScreen._watcherSetupUtil = param1;
      }
      ...
      private function _AchievementScreen_PointsProgress1_i() : PointsProgress
      {
      ...
      private function _AchievementScreen_CachedImage1_i() : CachedImage
      {
         ...
         this._AchievementScreen_CachedImage1 = _loc1_;
         BindingManager.executeBindings(this,"_AchievementScreen_CachedImage1",this._AchievementScreen_CachedImage1);
         return _loc1_;
      }
      
      private function _AchievementScreen_CachedImage2_i() : CachedImage
      {
         var _loc1_:CachedImage = new CachedImage();
         _loc1_.x = 306;
         this._AchievementScreen_CachedImage2 = _loc1_;
         BindingManager.executeBindings(this,"_AchievementScreen_CachedImage2",this._AchievementScreen_CachedImage2);
         return _loc1_;
      }
      
      private function _AchievementScreen_AchievementCategories1_i() : AchievementCategories
      {
      ...
      private function _AchievementScreen_List1_i() : List
      {
      ...
      private function _AchievementScreen_AchievementList1_i() : AchievementList
      {
      ...
      public function ___AchievementScreen_Container1_creationComplete(event:SimpleUIEvent) : void
      {
         this.creationComplete();
      }
      
      private function _AchievementScreen_bindingsSetup() : Array
      {
         var result:Array = [];
         ...
         },null,"_AchievementScreen_CachedImage1.source");
         result[3] = new Binding(this,function():Object
         {
            return Assets.questBg;
         },null,"_AchievementScreen_CachedImage2.source");
