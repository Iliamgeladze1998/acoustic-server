package mx.managers
{
   ...
   public class SystemManager extends MovieClip implements IChildList, IFlexDisplayObject, IFlexModuleFactory, ISystemManager
   {
      ...
      {
         return Boolean(this.topLevelWindow) ? this.topLevelWindow.getExplicitOrMeasuredHeight() : loaderInfo.height;
      }
      
      public function get measuredWidth() : Number
      {
         return Boolean(this.topLevelWindow) ? this.topLevelWindow.getExplicitOrMeasuredWidth() : loaderInfo.width;
      }
      ...
      mx_internal function initialize() : void
      {
         ...
         this.preloader.initialize(usePreloader,preloaderDisplayClass,this.preloaderBackgroundColor,this.preloaderBackgroundAlpha,this.preloaderBackgroundImage,this.preloaderBackgroundSize,this.isStageRoot ? this.stage.stageWidth : loaderInfo.width,this.isStageRoot ? this.stage.stageHeight : loaderInfo.height,null,null,rslItemList,resourceModuleURLs,domain);
      }
      ...
      private function initializeTopLevelWindow(event:Event) : void
      {
         ...
         else if(this.topLevel && Boolean(this.stage))
         {
         ...
         if(this.isStageRoot && Boolean(this.stage))
         {
            this.Stage_resizeHandler();
      ...
      {
         var obj:DisplayObjectContainer = null;
         if(!this.topLevel && Boolean(this.parent))
         {
            obj = this.parent.parent;
            while(Boolean(obj))
            {
