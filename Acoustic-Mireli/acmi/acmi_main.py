...
def run_script(script_path, stage_name, base_dir, required_output_files=None):
    """Run a Python script and handle errors with strict validation."""
    ...
    try:
        ...
        # Validate required output files exist and are not empty
...
def main():
    print("=" * 80)
    print("ACMI DATA PIPELINE ORCHESTRATOR")
    print("=" * 80)
    print()
    ...
    # Define the pipeline stages with required output files for validation
    stages = [
    ...
    # Run each stage in order with strict validation
